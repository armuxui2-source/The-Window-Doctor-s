...
export default function QuoteWizard({ initialServiceSlug, onSuccess }: QuoteWizardProps) {
  ...
  if (submittedRef) {
    return (
      <div className="bg-surface-container-lowest rounded-[24px] p-8 sm:p-12 text-center border border-outline-variant shadow-card space-y-6 animate-fade-in max-w-2xl mx-auto">
        <div className="w-16 h-16 rounded-[16px] bg-primary text-secondary-container flex items-center justify-center mx-auto">
        ...
        <div className="p-4 rounded-[16px] bg-surface-container-low border border-outline-variant inline-flex items-center gap-3">
        ...
        <div className="p-4 rounded-[16px] bg-surface-container border border-outline-variant text-left text-xs space-y-2 max-w-md mx-auto">
        ...
        <button
          ...
          className="btn-secondary text-sm py-2.5 px-6 rounded-[16px]"
        >
  ...
  return (
    <div className="bg-surface-container-lowest rounded-[24px] p-6 sm:p-10 border border-outline-variant shadow-card max-w-3xl mx-auto">
        ...
        <div className="hidden sm:flex items-center gap-2">
          {[1, 2, 3, 4].map((step) => (
            <div
              key={step}
              className={cn(
                "w-8 h-8 rounded-[10px] flex items-center justify-center text-xs font-bold transition-all",
                currentStep === step
      ...
      <form onSubmit={handleSubmit}>
              ...
              {MOCK_SERVICES.map((srv) => {
                ...
                return (
                  <div
                    ...
                    className={cn(
                      "p-4 rounded-[16px] border cursor-pointer transition-all duration-200 flex flex-col justify-between",
                      isSelected
          ...
          <div className="space-y-6 animate-fade-in">
              ...
              <div className="flex items-center gap-3">
                {[1, 2, 4, 6, 8, 12].map((num) => (
                  <button
                    ...
                    className={cn(
                      "flex-1 py-2.5 rounded-[12px] text-sm font-bold border transition-all",
                      itemCount === num
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-[16px] bg-surface-container-lowest border border-outline-variant text-primary text-sm focus:outline-none focus:border-primary font-medium"
                >
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-4 py-3 rounded-[16px] bg-surface-container-lowest border border-outline-variant text-primary placeholder-on-surface-variant/50 text-sm focus:outline-none focus:border-primary font-body"
              />
            </div>
          </div>
        )}
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3.5 pl-11 rounded-[16px] bg-surface-container-lowest border border-outline-variant text-primary font-mono text-base focus:outline-none focus:border-primary"
                />
            ...
            {postcodeStatus === "valid" && (
              <div className="p-4 rounded-[16px] bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs flex items-center gap-3">
            ...
            {postcodeStatus === "invalid" && (
              <div className="p-4 rounded-[16px] bg-amber-50 border border-amber-200 text-amber-900 text-xs flex items-center gap-3">
        ...
        {currentStep === 4 && (
          <div className="space-y-6 animate-fade-in">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="John"
                  className="w-full px-4 py-3 rounded-[16px] bg-surface-container-lowest border border-outline-variant text-primary text-sm focus:outline-none focus:border-primary"
                />
              </div>
            ...
            {/* Price Preview Card */}
            <div className="p-4 rounded-[16px] bg-surface-container-low border border-outline-variant flex items-center justify-between">
              <div>
        ...
        <div className="flex items-center justify-between pt-8 mt-8 border-t border-outline-variant">
          {currentStep > 1 ? (
            <button
              ...
              className="btn-secondary text-xs py-2.5 px-5 rounded-[16px]"
            >
          ...
          {currentStep < 4 ? (
            <button
              type="button"
              onClick={() => setCurrentStep((prev) => prev + 1)}
              className="btn-primary text-xs py-2.5 px-6 rounded-[16px]"
            >
              <span>Continue</span>
            ...
            <button
              ...
              className="btn-cta text-xs py-2.5 px-7 rounded-[16px]"
            >
